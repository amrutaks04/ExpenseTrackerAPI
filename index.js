 ...
 * Expense Tracker
 * Functionalities:
 * Adding a new expense -> end point -> /add-expense
...
app.use(bodyParser.json())
  ...
  app.use(cors()) // the back end can be accessed from any origin
...
//localhost:8002/delete-expense/65efdfa702c0a912111b74d5
